...
A partir del link de la búsqueda generado manualmente en la web del repositorio, como este:
...
Se llega a un csv que cargué a drive a fin de visualizar el ejemplo:
